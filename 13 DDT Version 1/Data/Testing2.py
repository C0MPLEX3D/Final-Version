...
class CaloricIntakeCalculator:
    def __init__(self, master):
        ...
        self.image_title = self.image_title.resize((700, 300))  # Resize the image
        ...
        self.entry_weight = tk.Entry(self.content_frame, font=("Verdana", 12), width=20, bd=2, relief="solid", justify="center", highlightthickness=2, highlightbackground="#000000")  # Set the width and other properties of the entry box
        ...
        self.entry_height = tk.Entry(self.content_frame, font=("Verdana", 12), width=20, bd=2, relief="solid", justify="center", highlightthickness=2, highlightbackground="#000000")  # Set the width and other properties of the entry box
        ...
        self.entry_age = tk.Entry(self.content_frame, font=("Verdana", 12), width=20, bd=2, relief="solid", justify="center", highlightthickness=2, highlightbackground="#000000")  # Set the width and other properties of the entry box
